...
export const AddressScreen = () => {
    ...
    const { object, register, watch, applyValidations, setValue } = useForm<AddressForm>({
        validations: {
            zipCode: value => {
    ...
    return (
        <MainTemplate title="Dados de Endereço">
            ...
            <View style={{ gap: width * 0.08 }}>
                <Fields.Input placeholder="CEP ex: 12345-678" keyboard="numeric" {...register('zipCode')} />
                ...
                >
                    <Fields.Input placeholder="Estado" size="sm" blocked {...register('state')} />

                    <Fields.Input placeholder="Cidade" size="sm" blocked {...register('city')} />
                </View>
                ...
                <Fields.Input placeholder="Ponto de Referência (opcional)" {...register('referencePoint')} />

                <Fields.Input placeholder="Complemento (opcional)" {...register('additionalInfo')} />
            </View>
