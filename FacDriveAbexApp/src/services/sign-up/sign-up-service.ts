...
import { ValidStudentIdInput, ValidStudentIdResponse } from './types/valid-student-id';
...
class SignUpService {
    ...
    async verifyEmailAlreadyRegistered(email: string): Promise<ValidateEmailResponse> {
    ...
    async verifyVehicleHasAlreadyRegistered(plate: string): Promise<{ plateAlreadyRegistered: boolean }> {
